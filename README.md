...
confirm(‘Você já é nosso aluno?’)
prompt(‘Digite o seu nome’)
```
```
O HTML é dividido entre as tagas <head> e <body>
O CSS pode ser inserido no HTML com a tag <style>
O JavaScript pode ser inserido no HTML com a tag <script>
```
